...
public class ServletUtils {
    ...
    public static JsonElement getValueFromPostAction(HttpServletRequest request, String key){
        PostAction postAction = createPostActionFromRequest(request);

        if(postAction != null){
            if(postAction.getValues().has(key)){
    ...
    public static void sendJSONResponse(HttpServletResponse response, HashMap jsonToSend){
