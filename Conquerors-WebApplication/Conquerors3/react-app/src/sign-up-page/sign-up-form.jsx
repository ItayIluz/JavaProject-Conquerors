  ...
  componentDidMount(){
    ...
    getDataFrom(SERVLET_PATH, responseJSON => {
      ...
      if(responseJSON.result == "CONNECTED")
        this.setState({connectedSuccessfully: true, inGameTitle: responseJSON.inGameTitle});
    });
  }
    ...
    if(userInput == ""){
      ...
      postActionTo(SERVLET_PATH, "postUsername", {username: userInput}, responseJSON => {
        if(responseJSON.result == "SUCCESS"){
          this.setState({connectedSuccessfully: true});
        } else {
    ...
    if(this.state.connectedSuccessfully){
      if(this.state.inGameTitle != null)
        return <Redirect to={{
          ...
          state: { gameTitle: this.state.inGameTitle }
        }}/>;
      else
