    ...
    for(let row = 0; row < this.props.boardRows; row++){
      for (let column = 0; column < this.props.boardColumns; column++) {
        ...
        board.push(<GameBoardTerritory 
          ...
          id={territoryIndex+1}
          profit={territories[i].id == territoryIndex ? territories[i].profit : this.props.defaultTerritoryProfit}
          armyThreshold={territories[i].id == territoryIndex ? territories[i].armyThreshold : this.props.defaultTerritoryArmyThreshold}
