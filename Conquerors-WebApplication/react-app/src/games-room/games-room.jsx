  ...
  render() {
    ...
    if(this.state.joinedGame) 
      return <Redirect to={{
                ...
                state: { playerUsername: this.state.playerUsername, gameTitle: this.state.joinedGameTitle }
              }}/>;
    ...
    return (
      <div className="main">
        ...
        <form ref={this.uploadFileForm} method="POST" action="/Conquerors/uploadFile" hidden>
          <input ref={this.uploadFileInput} type="file" name="uploadedFile" accept="text/xml" onChange={this.formSubmit} hidden/>
        </form> 
        <div className="buttons-container">
          <span><b>Logged in as <u>{this.state.playerUsername}</u></b></span>
